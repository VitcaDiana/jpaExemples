...
@Transactional(rollbackFor = Exception.class)
    public void transferMoney(Long fromAccoundId, Long toAccountId, Integer sum) throws Exception {
        Account fromAccount = accountRepository.findById(fromAccoundId).orElseThrow(() -> new EntityNotFoundException("from account not found"));
